...
const ConfirmAbortModal = ({ isOpen, onClose, onConfirm }: ConfirmAbortModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex justify-center items-center">
      <div className="bg-gray-800 p-6 rounded-lg text-gray-300 w-1/3 flex flex-col items-center flex flex-col relative border border-gray-600 shadow-lg">
        <h2 className="text-xl mb-4 text-gray-100">Are you sure?</h2>
        <p className="mb-4">
